...
const faqs = [
  {
    question: "מה מייחד את גרייטלנד תיווך בוטיק מסוכנויות נדל״ן אחרות?",
    answer: "גרייטלנד תיווך בוטיק חרטה על דגלה שירות אישי ומעטפת מלאה של 360 מעלות למוכרים וקונים. אנו משתמשים בכל ערוצי השיווק וכן במערכות מתקדמות (CRM) לייעול מקסימלי, ומקשרים אתכם למומחים מכל התחומים (שמאים, עו״ד, קבלנים)."
  },
  {
