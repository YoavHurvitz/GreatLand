  ...
  return (
    <section id="home" className="relative min-h-screen w-full flex flex-col bg-gray-900">
      ...
      <div className="relative z-10 flex-grow flex flex-col justify-center px-6 md:px-12 lg:px-24 pt-32 pb-16">
        ...
        >
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1, ease: 'easeOut' }} className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.15] md:leading-[1.1] tracking-tight drop-shadow-lg">המומחים שלכם <br className="hidden md:block"/> בשכונות <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-[#f4a261]">הצפון</span></motion.h1>

          <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2, ease: "easeOut" }} className="text-lg md:text-xl text-gray-200 max-w-2xl font-normal drop-shadow-md leading-relaxed md:leading-relaxed">חברת תיווך בוטיק המתמקדת אקסקלוסיבית בתל ברוך ונווה גן. פנטהאוזים, דירות יוקרה, ובתים פרטיים.</motion.p>
          ...
          >
            <a
              href="https://wa.me/9723-644-7111?text=%D7%94%D7%99%D7%99%2C%20%D7%90%D7%A0%D7%99%20%D7%9E%D7%A2%D7%95%D7%A0%D7%99%D7%99%D7%9F%20%D7%9C%D7%A7%D7%91%D7%9C%20%D7%A4%D7%A8%D7%98%D7%99%D7%9D%20%D7%A2%D7%9C%20%D7%A0%D7%9B%D7%A1%D7%99%D7%9D"
              target="_blank"
