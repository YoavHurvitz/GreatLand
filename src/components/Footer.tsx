      ...
      <div className="relative bg-gray-900 pt-24 pb-12 px-8 md:px-16 lg:px-24">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-12 mb-24 max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-white/70 text-lg max-w-md">
              משרד גרייטלנד תיווך בוטיק משווק נכסים פרטיים להשכרה ומכירה, עם ניסיון רב ואמינות ודירוגים מובילים. צוות מקצועי שעובד למענכם בלב אזורי הביקוש.
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-end gap-3 text-white/80 hover:text-white transition-colors">
              <span className="text-lg" dir="ltr">03-644-7111</span>
              <Phone className="w-5 h-5 text-accent" />
            </div>
            <a href="mailto:office@greatland.co.il" className="flex items-center justify-end gap-3 text-white/80 hover:text-white transition-colors">
              <span className="text-lg">office@greatland.co.il</span>
              <Mail className="w-5 h-5 text-accent" />
            </a>
            <div className="flex items-center justify-end gap-3 text-white/80 hover:text-white transition-colors">
              <span className="text-lg">תל ברוך דרום, תל אביב</span>
        ...
        <div className="relative z-10 border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6 max-w-7xl mx-auto">
          ...
          <div className="text-sm text-white/40">
            &copy; {new Date().getFullYear()} כל הזכויות שמורות לגרייטלנד תיווך בוטיק.
          </div>
        </div>
      </div>
    </footer>
